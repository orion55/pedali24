			...
			<?php if( get_field( 'mp_projects_show' ) ) : ?>
				...
				<!-- ################################## НАШИ ПРОЕКТЫ ################################ -->
				<section class="section section_projects section_projects_wide section_dark section_carousel" <?php if( $mp_projects_bg ) : echo 'style="background-image: url(\''.$mp_projects_bg.'\');"'; endif; ?>>
					<div class="container">
						<div class="row">
							<div class="col-lg-10 col-md-10 col-sm-10">
						...
						<?php if( have_rows('mp_partners_one') ) : 
						    ...
						    while ( have_rows('mp_partners_one') ) : the_row();
								...
								<div class="one_partner">
									<a <?php if( $mp_partners_one_link ) : echo 'href="'.$mp_partners_one_link.'"'; else : echo ''; endif; ?> target="_blank">
					...
					<div class="container">
						<div class="section_head">
							...
							<div class="section_head_btn <?php if( !($mp_blog_suptitle) ) : echo 'big_offset'; endif; ?>">
								<?php if( $mp_blog_btn ) : ?>
									<a href="<?php echo get_permalink( get_option( 'page_for_posts' ) ) ?>" class="btn btn_empty"><?php echo $mp_blog_btn; ?><i class="zmdi zmdi-arrow-right"></i></a>
								<?php endif; ?>
