				...
				<div role="main">
					<div class="section_projects section_projects_container">
						<div class="container">
							...
							<?php $site_options_projects_description = get_field( 'site_options_projects_description', 'option' ); ?>
							<?php if( $site_options_projects_description ) : echo '<div class="section_subtext">'.$site_options_projects_description.'</div>'; endif; ?>
