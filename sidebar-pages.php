								<aside class="sidebar sidebar_pages" role="complementary">
									...
									<!-- Вывод Меню Проектов, если оно есть -->

									<?php $site_options_projects_menu_title = get_field( 'site_options_projects_menu_title', 'option' ); ?>

									<?php if( has_nav_menu('projects_side_menu') ) { ?>

										<div class="sidebar_box sidebar_projects_menu">
											<?php if( $site_options_projects_menu_title ) : echo '<h2 class="title">'.$site_options_projects_menu_title.'</h2>'; endif; ?>
											<?php ninjatheme_projects_nav(); ?>
										</div> <!-- /.sidebar_projects_menu -->
									...
									<?php if(!function_exists('dynamic_sidebar') || !dynamic_sidebar('pages_widget_area')) ?>
