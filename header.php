...
<head>
    ...
    <link rel="icon" href="<?php echo get_template_directory_uri(); ?>/img/icons/favicon-32x32.png"
          sizes="32x32">
    <link rel="icon"
          href="<?php echo get_template_directory_uri(); ?>/img/icons/favicon-192x192.png"
          sizes="192x192">
    <link rel="apple-touch-icon-precomposed"
          href="<?php echo get_template_directory_uri(); ?>/img/icons/favicon-180x180.png">
    <meta name="msapplication-TileImage"
          content="<?php echo get_template_directory_uri(); ?>/img/icons/favicon-270x270.png">
    ...
    <noscript>
        <div><img src="https://mc.yandex.ru/watch/46688139" style="position:absolute; left:-9999px;"
                  alt=""/></div>
    </noscript>
    <!-- /Yandex.Metrika counter -->
...
<header class="main_header <?php if (is_front_page()) {
    echo 'main_page';
} else {
    echo 'inside_page';
} ?>" id="top">
    <div class="top_line">
        <div class="container">
            <ul class="top_contacts clearfix hidden-xs">
                ...
                <?php if ($site_options_mail) : echo '<li class="email"><i class="zmdi zmdi-email"></i><a href="mailto:', antispambot($site_options_mail);
                    echo '">', antispambot($site_options_mail);
                    echo '</a></li>'; endif; ?>
                                    ...
                                    <?php else : ?>
                                        <?php if ((!empty($site_options_logo_light)) || (!empty($site_options_logo_dark))) : ?>
                                            <a href="<?php echo home_url(); ?>"
                                               title="<?php bloginfo('name'); ?>" class="logoWrp">
                                                <?php
                                                if (!empty($site_options_logo_light)) : echo '<img src="' . $site_options_logo_light['url'] . '" alt="' . get_bloginfo('name') . '" class="logo_light">';
                                                else : echo '<b class="logo_text_light">' . get_bloginfo('name') . '</b>';
                                                endif;
